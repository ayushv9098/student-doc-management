          ...
          <CardContent>
            {loading ? (
              ...
              <div className="max-h-[360px] space-y-2 overflow-y-auto pr-1">
                {recent.map((s) => (
                  <div key={s.id} className="flex items-center justify-between gap-3 rounded-md border border-zinc-200 bg-white p-3 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:hover:bg-zinc-900">
                    <div>
                      <div className="font-medium">{s.fullName}</div>
                      <div className="text-xs text-zinc-500">{s.className} • {s.mobile}</div>
                    </div>
